      ...
      body: SingleChildScrollView(
        ...
        mobileBuilder: (context, constraints) {
          return Column(children: [
            ...
            TaskToDoDetails(task: widget.task),
          ]);
        },
          ...
          return Row(
            ...
            children: [
              Flexible(
                ...
                child: TaskToDoDetails(task: widget.task),
              ),
...
class TaskToDoDetails extends StatefulWidget {
  final TaskToDo task;

  const TaskToDoDetails({
    Key? key,
    required this.task,
  }) : super(key: key);

  @override
  _TaskToDoDetailsState createState() => _TaskToDoDetailsState();
}
...
class _TaskToDoDetailsState extends State<TaskToDoDetails> {
  ...
  void sendPoints() {
    ...
    adminServices.changeTaskToDoStatus(
      context: context,
      status: 'approved',
      task: widget.task,
    );
