...
class TaskApprovedCard extends StatelessWidget {
  final TaskApproved taskApproved;

  const TaskApprovedCard({Key? key, required this.taskApproved})
      : super(key: key);
      ...
      child: Stack(
        ...
        children: [
          _TaskDetails(
            ...
            title: taskApproved.title,
            // subTitle: task.description,
            type: taskApproved.type,
            priority: taskApproved.priority,
          ),
        ],
      ),
